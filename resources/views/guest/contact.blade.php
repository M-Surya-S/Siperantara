                ...
                <div class="row gy-30">
                    <div class="col-xxl-4 col-xl-4 col-lg-4">
                        <div class="contact-box">
                            ...
                            <div class="contact-content mb-70">
                                <a target="_blank" href="https://wa.me/628115171010">
                                    +62 811-517-1010
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-4">
                        <div class="contact-box">
                            ...
                            <div class="contact-content mb-70">
                                <a href="mailto:siperantararealestate@gmail.com">
                                    siperantararealestate@gmail.com
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-4 col-xl-4 col-lg-4">
                        <div class="contact-box">
                            ...
                            <div class="contact-content">
                                <a target="_blank" href="https://maps.app.goo.gl/Kg9aYDF6PLd3nM1J6">Komplek Balikpapan Permai, Jl. Jenderal Sudirman No.9 Blok
                                    L, Damai, Kecamatan Balikpapan Selatan, Kota Balikpapan, Kalimantan Timur 76114
                                </a>
                            </div>
                        </div>
                    </div>
