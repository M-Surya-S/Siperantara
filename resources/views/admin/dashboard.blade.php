                ...
                <div class="card-body">
                    <div class="card__box-wrapp">
                      ...
                      <span class="price-increase">
                        ...
                        <div class="reallow-progress-bar">
                            <div class="reallow-progress">
                                <div class="reallow-progress-wrapper">
                                    <div class="reallow-progress-head">
                                        <h3 class="reallow-progress-title">Excellent<span>/5 Star</span></h3>
                                        <span class="reallow-progress-percentage">44%</span>
                                    </div>
                                    <div class="progress">
                                ...
                                <div class="reallow-progress-wrapper">
                                    <div class="reallow-progress-head">
                                        <h3 class="reallow-progress-title">Very Good<span>/4 Star</span></h3>
                                        <span class="reallow-progress-percentage">22%</span>
                                    </div>
                                    <div class="progress">
                                ...
                                <div class="reallow-progress-wrapper">
                                    <div class="reallow-progress-head">
                                        <h3 class="reallow-progress-title">Good<span>/3 Star</span></h3>
                                        <span class="reallow-progress-percentage">18%</span>
                                    </div>
                                    <div class="progress">
                                ...
                                <div class="reallow-progress-wrapper">
                                    <div class="reallow-progress-head">
                                        <h3 class="reallow-progress-title">Poor<span>/2 Star</span></h3>
                                        <span class="reallow-progress-percentage">7%</span>
                                    </div>
                                    <div class="progress">
                                ...
                                <div class="reallow-progress-wrapper">
                                    <div class="reallow-progress-head">
                                        <h3 class="reallow-progress-title">Very Poor<span>/1 Star</span></h3>
                                        <span class="reallow-progress-percentage">4%</span>
                                    </div>
                                    <div class="progress">
