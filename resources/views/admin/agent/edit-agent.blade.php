...
<div class="mb-6">
    ...
    <p class="text-gray-500 text-sm mt-1">Update details for agent {{ $agent->name }}.</p>
</div>

    <form action="{{ route('update-agent.update', $agent->id) }}" method="POST" enctype="multipart/form-data" class="flex flex-col xl:flex-row gap-6 items-start">
        @csrf
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" id="name" name="name" value="{{ $agent->name }}" required class="w-full rounded-lg border-gray-300 border px-4 py-2.5 focus:border-blue-500 focus:ring-blue-500 sm:text-sm transition-colors outline-none">
                    </div>

                    <div>
                        <label for="email" class="block text-sm font-medium text-gray-700 mb-1">Email Address <span class="text-red-500">*</span></label>
                        <input type="email" id="email" name="email" value="{{ $agent->email }}" required class="w-full rounded-lg border-gray-300 border px-4 py-2.5 focus:border-blue-500 focus:ring-blue-500 sm:text-sm transition-colors outline-none">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="phone_number" name="phone_number" value="{{ $agent->phone_number }}" required class="w-full rounded-lg border-gray-300 border px-4 py-2.5 focus:border-blue-500 focus:ring-blue-500 sm:text-sm transition-colors outline-none">
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="url" id="instagram_link" name="instagram_link" value="{{ $agent->instagram_link }}" placeholder="https://instagram.com/..." class="w-full pl-10 rounded-lg border-gray-300 border px-4 py-2.5 focus:border-blue-500 focus:ring-blue-500 sm:text-sm transition-colors outline-none">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="url" id="linkedin_link" name="linkedin_link" value="{{ $agent->linkedin_link }}" placeholder="https://linkedin.com/in/..." class="w-full pl-10 rounded-lg border-gray-300 border px-4 py-2.5 focus:border-blue-500 focus:ring-blue-500 sm:text-sm transition-colors outline-none">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="url" id="facebook_link" name="facebook_link" value="{{ $agent->facebook_link }}" placeholder="https://facebook.com/..." class="w-full pl-10 rounded-lg border-gray-300 border px-4 py-2.5 focus:border-blue-500 focus:ring-blue-500 sm:text-sm transition-colors outline-none">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="url" id="twitter_link" name="twitter_link" value="{{ $agent->twitter_link }}" placeholder="https://twitter.com/..." class="w-full pl-10 rounded-lg border-gray-300 border px-4 py-2.5 focus:border-blue-500 focus:ring-blue-500 sm:text-sm transition-colors outline-none">
                        </div>
                    </div>
        ...
        <div class="w-full xl:w-[400px] shrink-0 space-y-6 xl:sticky xl:top-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="flex flex-col items-center gap-4">
                    <div id="imagePreview" class="w-32 h-32 rounded-full bg-gray-200 bg-cover bg-center shrink-0 border-4 border-white shadow-md mx-auto" style="background-image: url('{{ Storage::url($agent->image) }}');"></div>
                    ...
                    <div class="w-full">
                        <label for="imageUpload" class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer bg-gray-50 hover:bg-gray-100 hover:border-blue-400 transition-colors">
                            <div class="flex flex-col items-center justify-center pt-5 pb-6 text-center px-4">
                                ...
                                <p class="mb-1 text-sm text-gray-500"><span class="font-semibold text-blue-600">Click to update photo</span></p>
