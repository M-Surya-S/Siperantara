...
<div class="mb-6">
    ...
    <p class="text-gray-500 text-sm mt-1">Write and publish a new article for your website.</p>
</div>

    <form action="{{ route('add-blog.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col xl:flex-row gap-6 items-start">
        @csrf
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" id="blogTitle" name="blog_title" placeholder="Enter an engaging title" required class="w-full rounded-lg border-gray-300 border px-4 py-2.5 focus:border-blue-500 focus:ring-blue-500 sm:text-sm transition-colors outline-none font-medium">
                    </div>

                    <div class="md:col-span-2">
                        <label for="writter" class="block text-sm font-medium text-gray-700 mb-1">Author / Writer <span class="text-red-500">*</span></label>
                        <input type="text" id="writter" name="writter" placeholder="e.g. Admin or John Doe" required class="w-full rounded-lg border-gray-300 border px-4 py-2.5 focus:border-blue-500 focus:ring-blue-500 sm:text-sm transition-colors outline-none">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="space-y-4">
                    <div id="imagePreviewContainer" class="flex justify-center">
                        <div id="imagePreview" class="w-full h-48 rounded-xl bg-gray-200 bg-cover bg-center shrink-0 border border-gray-300 shadow-sm" style="background-image: url('{{ asset('assets/images/blog/image-mockup.png') }}');"></div>
                    </div>
                    ...
                    <div class="flex items-center justify-center w-full">
                        <label for="imageUpload" class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer bg-gray-50 hover:bg-gray-100 hover:border-blue-400 transition-colors">
                            ...
                            <input id="imageUpload" type="file" class="hidden" accept=".png, .jpg, .jpeg" name="image" required>
                        </label>
                    </div>
                </div>
            </div>
