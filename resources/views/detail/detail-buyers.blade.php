            ...
            <div class="row justify-content-center">
                <div class="col-xxl-6 col-xl-6 col-lg-6">
                    <div class="section-title-wrapper anim-wrapper section-title-space text-center animation-style-3">
                        <h2 class="section-title title-animation">Buyer's Guide</h2>
                    </div>
                </div>
            </div>
            <div class="row g-5 justify-content-between justify-content-md-center">
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div class="services-item style-one wow bdFadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                        <div class="content">
                            <h3 class="title"><a href="/buyers-guide">1. Lorem Ipsum</a></h3>
                            <p class="description">The rent property kitchen invites you to whip up delicious meals, while the cozy bedroom promises sleep</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div class="services-item style-one wow bdFadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                        <div class="content">
                            <h3 class="title"><a href="#">2. Lorem Ipsum</a></h3>
                            <p class="description">Choose us for your real estate needs and experience unparalleled expertise and dedication.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div class="services-item style-one wow bdFadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                        <div class="content">
                            <h3 class="title"><a href="#">3. Lorem Ipsum</a></h3>
                            <p class="description">With years of industry experience, our team boasts an in-depth understanding of the market knowledge.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div class="services-item style-one wow bdFadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                        <div class="content">
                            <h3 class="title"><a href="#">4. Lorem Ipsum</a></h3>
                            <p class="description">The rent property kitchen invites you to whip up delicious meals, while the cozy bedroom promises sleep</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div class="services-item style-one wow bdFadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                        <div class="content">
                            <h3 class="title"><a href="#">5. Lorem Ipsum</a></h3>
                            <p class="description">The rent property kitchen invites you to whip up delicious meals, while the cozy bedroom promises sleep</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div class="services-item style-one wow bdFadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                        <div class="content">
                            <h3 class="title"><a href="#">6. Lorem Ipsum</a></h3>
                            <p class="description">The rent property kitchen invites you to whip up delicious meals, while the cozy bedroom promises sleep</p>
                        </div>
                    </div>
                </div>
