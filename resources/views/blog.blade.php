                        ...
                        <div class="postbox__wrapper">
                            <article class="postbox__item format-image mb-50 transition-3">
                                <div class="postbox__thumb w-img">
                                    <a href="/blog/detail">
                                        <img src="{{ asset('assets/images/blog/postbox/blog-post-01.png') }}"
                                            alt="image">
                                    </a>
                                </div>
                                <div class="postbox__content">
                                    <div class="post-details-meta mb-20">
                                        <div class="post-details-meta-inner">
                                            <div class="post-details-meta-user">
                                                <img src="{{ asset('assets/images/user/user-thumb-07.png') }}" alt="author">
                                                <span>by
                                                    <a>Ellena M.Rice</a>
                                                </span>
                                            </div>
                                    ...
                                    <h3 class="postbox__title">
                                        <a href="/blog/detail">The Future of Real Estate Emerging Trends and
                                            Technologies</a>
                                    </h3>
                                    <div class="postbox__text">
                                        <p>Create a stunning real estate blog with rellow Real Estate Before diving into the
                                            world
                                            of rental property investment, it's essential to conduct thorough market
                                            research,
                                            understand local regulations, and assess your financial readiness. Real estate
                                            investing requires careful consideration and a long-term perspective Whether you
                                            are a
                                            real estate agent, broker, or enthusiast provides a professional platform to
                                            share your
                                            insights.
                                        </p>
                                    </div>
                                    <div class="postbox__read-more">
                                        <a class="bd-half-outline-btn" href="/blog-details"><span class="text">read
                                                more</span></a>
                                    </div>
                                </div>
                            </article>
                            <article class="postbox__item format-video mb-50 transition-3">
                                <div class="postbox__thumb postbox__video w-img p-relative">
                                    ...
                                    <a class="play-btn popup-video"
                                        href="https://www.youtube.com/watch?v=ec_fXMrD7Ow"><span><i
                                ...
                                <div class="postbox__content">
                                    ...
                                    <h3 class="postbox__title">
                                        <a href="blog-details.html">Sustainable Living Eco-Friendly Features to Look for in
                                            Your
                                            Next Home</a>
                                    </h3>
                                    <div class="postbox__text">
                                        <p>
                                            The real estate Whether you're a first-time homebuyer, an experienced investor,
                                            or a
                                            real estate professional, our blog is designed to provide valuable information,
                                            expert
                                            advice, and the latest trends in the industry. Create a stunning real estate
                                            blog with
                                            rellow Real Estate Before diving into the world of rental property investment,
                                            it's
                                            essential to conduct thorough market research, understand local regulations.
                                        </p>
                                    </div>
                                    <div class="postbox__read-more">
                                        <a class="bd-half-outline-btn" href="blog-details.html"><span class="text">read
                                                more</span></a>
                                    </div>
                                </div>
                            </article>
                                ...
                                <div class="postbox__quote postbox__quote-style-3">
                                    <div class="blog__grid-quote mb-30">
                                        ...
                                        <div class="blog__grid-quote-content">
                                            ...
                                            <p>You have to be burning with an idea, or a problem, or a wrong that you want
                                                to
                            ...
                            <article class="postbox__item format-image mb-50 transition-3">
                                <div class="postbox__thumb postbox__slider swiper w-img p-relative">
                                    <div class="swiper-wrapper">
                                        <div class="postbox__slider-item swiper-slide">
                                            <img src="assets/images/blog/postbox/slider/blog-post-slider-01.png"
                                                alt="image">
                                        </div>
                                        <div class="postbox__slider-item swiper-slide">
                                            <img src="assets/images/blog/postbox/slider/blog-post-slider-02.png"
                                                alt="image">
                                        </div>
                                        <div class="postbox__slider-item swiper-slide">
                                            <img src="assets/images/blog/postbox/slider/blog-post-slider-03.png"
                                                alt="image">
                                        </div>
                                    </div>
                                ...
                                <div class="postbox__content">
                                    ...
                                    <h3 class="postbox__title">
                                        <a href="blog-details.html">The Dos and Don'ts of Selling Your Home in a
                                            Competitive
                                            Market</a>
                                    </h3>
                                    <div class="postbox__text">
                                        <p>At Real Estate Insights Blog, we are a team of seasoned real estate
                                            professionals,
                                            ...
                                            complexities of real estate and offer practical, actionable advice for all your
                                            real
                                ...
                                <div class="sidebar-widget-content">
                                    <div class="sidebar-about">
                                        <div class="sidebar-about-thumb mb-25">
                                            <a href="#">
                                                <img src="assets/images/user/user-thumb-09.png"
