...
<body>
    ...
    <main>
                                    ...
                                    <div class="col-xxl-7 col-xl-6 col-lg-5 col-md-5">
                                        <div class="banner-content p-relative wow bdFadeInLeft" data-wow-delay=".3s" data-wow-duration=".7s">
                                            <h1 class="banner-title">
                                                ...
                                                <span class="text-gradient"><img class="arrow-shape" src="assets/images/shapes/banner-arrow.svg"
                                                    alt="banner-arrow">A Home</span>
                                            </h1>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-5">
                        <div class="about-content style-one">
                           ...
                           since from 1990
                                ...
                                <h2 class="section-title title-animation is-br-none">Solutions that <br> inspire progress</h2>
                            </div>
                            <div class="about-tab">
                                <div class="bd-tab">
                                    <ul class="nav nav-tabs" id="myTab1" role="tablist">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="quality-tab" data-bs-toggle="tab" data-bs-target="#quality-tab-pane" type="button" role="tab" aria-controls="quality-tab-pane" aria-selected="false">Quality</button>
                                        </li>
                                    </ul>
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="expertise-tab-pane" role="tabpanel" aria-labelledby="expertise-tab" tabindex="0">
                                            <div class="about-tab-contnent">
                                                <p class="description">Choose us for your real estate needs and experience
                                                    unparalleled expertise and dedication. With years of industry experience, our
                                        ...
                                        <div class="tab-pane fade" id="results-tab-pane" role="tabpanel" aria-labelledby="results-tab" tabindex="0">
                                            <div class="about-tab-contnent">
                                                <p class="description">The result of working in real estate involves several key
                                                    steps, whether you are an agent, broker, or investor. Pursue continuing education
                                        ...
                                        <div class="tab-pane fade" id="quality-tab-pane" role="tabpanel" aria-labelledby="quality-tab" tabindex="0">
                                            <div class="about-tab-contnent">
                                                <p class="description">Working quality in real estate is crucial for achieving
                                                    success and maintaining a positive reputation.It encompasses various aspects such
                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                        <div class="services-item style-one wow bdFadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                            ...
                            <div class="content">
                                ...
                                <p class="description">The rent property kitchen invites you to whip up delicious meals, while
                ...
                <div class="row g-5 align-items-xl-center">
                    <div class="col-xxl-6 col-xl-6 col-lg-6">
                        <div class="daily-update-thumb-wrapper wow bdFadeInLeft" data-wow-delay=".3s">
                            ...
                            <div class="thumb">
                                <div class="figure">
                                    <img src="assets/images/daily-update/daily-update-01.png" alt="Image">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        get daily update
                                ...
                                <h2 class="section-title title-animation">Find your dream home or house today</h2>
                            </div>

                            <div class="content">
                                <p class="description">We believe in more than just buying and selling properties. we believe in
                                    turning dreams into reality. Explore our curated selection of homes tailored to your unique
                                    preferences and lifestyle.</p>
                                <div class="daily-update-item-list">
                                    <ul>
                            ...
                            <div class="bd-common-form-wrapper">
                                <form action="#">
                                    <div class="bd-common-form">
                                        ...
                                        <button class="bd-btn btn-style btn-hover-x" type="submit"> <i
                                    class="far fa-arrow-right"></i>Subscribe</button>
                                    </div>
                                    <div class="more-info">
                                        <span>*For more info <a href="contact.html">contact us</a> </span>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <div class="thumb">
                                        <figure><img src="assets/images/brand/brand-thumb-01.png" alt="Image">
                                        </figure>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <div class="thumb">
                                        <figure><img src="assets/images/brand/brand-thumb-02.png" alt="Image">
                                        </figure>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <div class="thumb">
                                        <figure><img src="assets/images/brand/brand-thumb-03.png" alt="Image">
                                        </figure>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <div class="thumb">
                                        <figure><img src="assets/images/brand/brand-thumb-04.png" alt="Image">
                                        </figure>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <div class="thumb">
                                        <figure><img src="assets/images/brand/brand-thumb-05.png" alt="Image">
                                        </figure>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="bd-apartment-area section-space">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xxl-6 col-xl-6 col-lg-6">
                        <div class="section-title-wrapper text-center anim-wrapper animation-style-3 section-title-space">
                            <span class="section-subtitle uppercase">
        <i class="icon-home"></i>
        apartment sketch
    </span>
                            <h2 class="section-title title-animation">Apartments plan</h2>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="apartments-tab text-center">
                            <div class="nav section-title-space">
                                <a data-bs-toggle="tab" href="#apartment-tab-1">The House</a>
                                <a class="active show" data-bs-toggle="tab" href="#apartment-tab-2">Deluxe Portion</a>
                ...
                <div class="tab-content wow bdFadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                            ...
                            <div class="row align-items-center g-5">
                                <div class="col-lg-6">
                                    <div class="apartments-plan-info">
                                        ...
                                        <p>The suitability of a house apartment building for your needs, whether you're looking to
                                            rent or buy. If studio have any specific buildings or further details in mind, feel
                                            free to provide more information.</p>
                                ...
                                <div class="col-lg-6">
                                    <div class="apartments-plan-thumb">
                                        <figure><img src="assets/images/apartment/apartment-plan-thumb-01.png" alt="Image">
                                        </figure>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row align-items-center g-5">
                                <div class="col-lg-6">
                                    <div class="apartments-plan-info">
                                        ...
                                        <p>That a deluxe real estate portion meets your expectations for luxury, comfort, and
                                            investment value
                                            Larger living spaces with ample room for various activities integrated home automation
                                            systems for lighting climate control.</p>
                                        <div class="apartments-info-list apartments-info-list-color">
                                            <ul>
                                ...
                                <div class="col-lg-6">
                                    <div class="apartments-plan-thumb">
                                        <figure><img src="assets/images/apartment/apartment-plan-thumb-02.png" alt="Image">
                                        </figure>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row align-items-center g-5">
                                <div class="col-lg-6">
                                    <div class="apartments-plan-info">
                                        ...
                                        <p>The better assess the value and suitability of a penthouse property for your needs
                                            ensuring it meets your expectations for luxury comfort and investment potential located
                                            in prime neighborhoods or central business districts.</p>
                                        <div class="apartments-info-list apartments-info-list-color">
                                            <ul>
                                ...
                                <div class="col-lg-6">
                                    <div class="apartments-plan-thumb">
                                        <figure><img src="assets/images/apartment/apartment-plan-thumb-03.png" alt="Image">
                                        </figure>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row align-items-center g-5">
                                <div class="col-lg-6">
                                    <div class="apartments-plan-info">
                                        ...
                                        <p> Warehouse real estate, whether for purchase, lease, or investment, there are several
                                            important details and features to evaluate Demand for warehouse space in the area,
                                            vacancy rates, and market trends.</p>
                                        <div class="apartments-info-list apartments-info-list-color">
                                            <ul>
                                ...
                                <div class="col-lg-6">
                                    <div class="apartments-plan-thumb">
                                        <figure><img src="assets/images/apartment/apartment-plan-thumb-04.png" alt="Image">
                                        </figure>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row align-items-center g-5">
                                <div class="col-lg-6">
                                    <div class="apartments-plan-info">
                                        ...
                                        <p>The informed decision about urban real estate properties, ensuring they meet your needs
                                            and expectations planned or potential future developments in the area that could impact
                                            property value.</p>
                                        <div class="apartments-info-list apartments-info-list-color">
                                            <ul>
                                ...
                                <div class="col-lg-6">
                                    <div class="apartments-plan-thumb">
                                        <figure><img src="assets/images/apartment/apartment-plan-thumb-05.png" alt="Image">
                                        </figure>
                                    </div>
                                </div>
                            </div>
        ...
        Why choose us
                ...
                <div class="row g-5">
                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                        <div class="why-choose-item style-one wow bdFadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                            <div class="icon">
                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                        <div class="why-choose-item style-one wow bdFadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                            <div class="icon">
                ...
                <div class="row g-5 wow bdFadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                    <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
                        <div class="neighbour-area-item">
                            <div class="thumb">
                                <figure><img src="assets/images/neighbour/neighbour-01.png" alt="Image">
                                </figure>
                            </div>
                            <div class="content">
                                <span class="info">04 properties</span>
                                <h3 class="title"><a href="property-details.html">Claremont</a></h3>
                            </div>
                    ...
                    <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
                        <div class="neighbour-area-item">
                            <div class="thumb">
                                <figure><img src="assets/images/neighbour/neighbour-02.png" alt="Image">
                                </figure>
                            </div>
                            <div class="content">
                                <span class="info">08 properties</span>
                                <h3 class="title"><a href="property-details.html">New Jersey</a></h3>
                            </div>
                            <a class="link" href="property-details.html"><i class="fa-regular fa-arrow-up-right"></i></a>
                        </div>
                    </div>
                    <div class="col-xxl-6 col-xl-6 col-lg-4 col-md-6">
                        <div class="neighbour-area-item">
                            <div class="thumb">
                                <figure><img src="assets/images/neighbour/neighbour-03.png" alt="Image">
                                </figure>
                            </div>
                            <div class="content">
                                <span class="info">04 properties</span>
                                <h3 class="title"><a href="property-details.html">California</a></h3>
                            </div>
                            <a class="link" href="property-details.html"><i class="fa-regular fa-arrow-up-right"></i></a>
                        </div>
                    </div>
                    <div class="col-xxl-6 col-xl-6 col-lg-4 col-md-6">
                        <div class="neighbour-area-item">
                            <div class="thumb">
                                <figure><img src="assets/images/neighbour/neighbour-04.png" alt="Image">
                                </figure>
                            </div>
                            <div class="content">
                                <span class="info">14 properties</span>
                                <h3 class="title"><a href="property-details.html">Kanas</a></h3>
                            </div>
                            <a class="link" href="property-details.html"><i class="fa-regular fa-arrow-up-right"></i></a>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
                        <div class="neighbour-area-item">
                            <div class="thumb">
                                <figure><img src="assets/images/neighbour/neighbour-05.png" alt="Image">
                                </figure>
                            </div>
                            <div class="content">
                                <span class="info">07 properties</span>
                                <h3 class="title"><a href="property-details.html">Louisiana</a></h3>
                            </div>
                            <a class="link" href="property-details.html"><i class="fa-regular fa-arrow-up-right"></i></a>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
                        <div class="neighbour-area-item">
                            <div class="thumb">
                                <figure><img src="assets/images/neighbour/neighbour-06.png" alt="Image">
                                </figure>
                            </div>
                            <div class="content">
                                <span class="info">02 properties</span>
                                <h3 class="title"><a href="property-details.html">Abilene</a></h3>
                            </div>
                            <a class="link" href="property-details.html"><i class="fa-regular fa-arrow-up-right"></i></a>
                        </div>
                    </div>
                        ...
                        <div class="team-content-inner d-flex flex-column justify-content-between h-100">
                            <div class="team-intro-content style-one">
                              ...
                              Team members
                                ...
                                <a class="bd-half-outline-btn" href="agent-grid.html"><span class="text">Discover More</span></a>
                            </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="team-item style-two">
                                            <div class="thumb">
                                                <figure><a href="agent-details.html"><img src="assets/images/agent/agent-01.png" alt="Image"></a></figure>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="team-item style-two">
                                            <div class="thumb">
                                                <figure><a href="agent-details.html"><img src="assets/images/agent/agent-02.png" alt="Image"></a></figure>
                                            </div>
                                            <div class="content-inner">
                                                <div class="content">
                                                    <h3 class="title"><a href="agent-details.html">Todd C. Rivera</a></h3>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="team-item style-two">
                                            <div class="thumb">
                                                <figure><a href="agent-details.html"><img src="assets/images/agent/agent-05.png" alt="Image"></a></figure>
                                            </div>
                                            <div class="content-inner">
                                                <div class="content">
                                                    <h3 class="title"><a href="agent-details.html">Melvin K. Thorne</a></h3>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="team-item style-two">
                                            <div class="thumb">
                                                <figure><a href="agent-details.html"><img src="assets/images/agent/agent-04.png" alt="Image"></a></figure>
                                            </div>
                                            <div class="content-inner">
                                                <div class="content">
                                                    <h3 class="title"><a href="agent-details.html">Burt M. Guthrie</a></h3>
        ...
        <div class="bd-video-area style-one position-relative jarallax">
            <div class="video-bg-thumb include-bg jarallax-img" data-background="assets/images/bg/video-bg-01.png">
            </div>
            <div class="container">
                <div class="row justify-content-center">
                                  ...
                                  <svg width="21" height="15" viewBox="0 0 21 15" fill="none"
                                     ...
                                     <path
                                        ...
                                        fill="#ED6E5A" />
                                            ...
                                            <p class="description">“I can't thank Reallow enough for their exceptional service. As a
                                                first-time homebuyer, I was nervous about the process, but their team guided me.”</p>
                                        </div>
                                        <div class="admin-item">
                                            <div class="admin-thumbnail">
                                                <img src="assets/images/user/user-thumb-01.png" alt="Admin Avatar">
                                            </div>
                                  ...
                                  <svg width="21" height="15" viewBox="0 0 21 15" fill="none"
                                     ...
                                     <path
                                        ...
                                        fill="#ED6E5A" />
                                            ...
                                            <p class="description">“Working with Reallow was a game-changer for us. Their team's
                                                attention to detail and market knowledge helped us find our dream home in no time.”</p>
                                        </div>
                                        <div class="admin-item">
                                            <div class="admin-thumbnail">
                                                <img src="assets/images/user/user-thumb-02.png" alt="Admin Avatar">
                                            </div>
                                            <div class="admin-info">
                                ...
                                <div class="swiper-slide">
                                  ...
                                  <svg width="21" height="15" viewBox="0 0 21 15" fill="none"
                                     ...
                                     <path
                                        ...
                                        <div class="admin-item">
                                            <div class="admin-thumbnail">
                                                <img src="assets/images/user/user-thumb-03.png" alt="Admin Avatar">
                                            </div>
                                            <div class="admin-info">
        ...
        News & Blogs
                ...
                <div class="row g-5 justify-content-center">
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="blog-item style-one wow bdFadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                            ...
                            <div class="blog-content">
                              ...
                              May 20, 2023
                                    ...
                                    <div class="blog-tags">
                                        ...
                                        <span><a href="#">Decorate</a></span>
                                    </div>
                                </div>
                                <h3 class="title">
                                    <a href="blog-details.html">Best ways to decorate your home and property</a>
                                </h3>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="blog-item style-one wow bdFadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                            <div class="blog-thumb">
                                <figure>
                            ...
                            <div class="blog-content">
                              ...
                              June 24, 2022
                                ...
                                <h3 class="title">
                                    <a href="blog-details.html">Real state build quality of modern real estate house</a>
                                </h3>
                                <div class="blog-content-bottom">
                                    <div class="blog-author">
                                        <i class="fa-regular fa-user"></i>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="blog-item style-one wow bdFadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                            <div class="blog-thumb">
                                <figure>
                            ...
                            <div class="blog-content">
                              ...
                              Feb 15, 2021
                                ...
                                <h3 class="title">
                                    <a href="blog-details.html">Best popular real estae area you can choose from</a>
                                </h3>
                                <div class="blog-content-bottom">
                                    <div class="blog-author">
                                        <i class="fa-regular fa-user"></i>
                        ...
                        <div class="contact-info wow bdFadeInLeft" data-wow-delay=".3s" data-wow-duration="1s">
                            ...
                            <div class="item">
                                <div class="content">
                                    ...
                                    <span class="info"><a href="mailto:reallow@mail.com">reallow@mail.com</a></span>
                                </div>
                                <div class="icon">
                ...
                <div class="row justify-content-between g-5">
                    ...
                    <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-3 col-sm-4">
                        <div class="footer-widget footer-1-col-3">
                            ...
                            <div class="footer-widget-links">
                                <ul>
                                    <li class="underline"><a href="property-details.html">Sustainability</a></li>
                                    <li class="underline"><a href="about.html">Careers</a></li>
                                    <li class="underline"><a href="contact.html">Media</a></li>
                                    <li class="underline"><a href="property.html">Offer</a></li>
                                    <li class="underline"><a href="shop.html">Products</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
